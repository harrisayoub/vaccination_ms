@component('mail::message')
  # Warning 2 - Reminder Advice for Mob {{$mob->mob_id}}


  <p>Innoculation Details MUST be made. Witholding periods must be noted by the system as the animals cannot be salughtered for human
